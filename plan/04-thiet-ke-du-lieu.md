...
⚠️ **Chưa có file PDF thực tế** nên cấu trúc dưới đây là dự kiến — sẽ điều chỉnh sau khi xem file (Q&A A1, A2, A3).
...
### 1.2 Các trường trích xuất (tùy PDF có gì — Q&A A2)
- Từ tiếng Anh (bắt buộc)
- Nghĩa tiếng Việt (bắt buộc)
- Phiên âm (nếu có)
- Loại từ (nếu có)
- Ví dụ (nếu có)
- Chương/bài (để chia FR-3)
- Hình ảnh (nếu có — Q&A A5)
...
⚠️ Chọn 1 trong 2 (Q&A D1):

### Phương án A (mặc định đề xuất): SM-2 (lặp lại ngắt quãng)
```
...
## 4. Dịch (FR-4) — dữ liệu
- Mặc định offline: tra `words` (Anh→Việt) và tra ngược `meaning_vi` (Việt→Anh) + bảng cụm từ nếu có.
- ⚠️ Nếu cần dịch câu chất lượng cao → cần API online (Q&A B1).
